...
public class FlutterSegmentPlugin implements MethodCallHandler {
    ...
    public static void registerWith(Registrar registrar) {
        ...
        try {
            ...
            analytics.onIntegrationReady("Mixpanel", new Analytics.Callback() {
                @Override
                public void onReady(Object instance) {
                    mixpanelAPI = (MixpanelAPI) instance;
...
// Set the initialized instance as a globally accessible instance.
    ...
    private void identify(MethodCall call, Result result) {
        try {
            ...
            analyticsContext.putDeviceToken(mixpanelAPI.getPeople().getPushRegistrationId());
            result.success(true);
        } catch (Exception e) {
